...
metadata:
  openclaw:
    user-invocable: true
    slash-command: guazi-design-style-guide
    emoji: "🎨"
...
Use this skill as the visual authority for Guazi-style work inside OpenClaw.
...
- If the current OpenClaw environment does not support direct Figma or design-system tooling, still use these rules as the visual source of truth for code and layout decisions
